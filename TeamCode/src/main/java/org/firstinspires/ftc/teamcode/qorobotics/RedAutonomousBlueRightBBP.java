 ...
 * QUALIFIER 2
 *
 * BBP - Beacon Beacon Park center (pushes ball if present)
 *
 * Created by Derek Zhang on 12/26/16.
 */
@Autonomous(name = "Auto Blue Right BBP", group = "Red")
public class RedAutonomousBlueRightBBP extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //velocity <0, max>
        //move forward yeah
        runMotor(0.0, MAX_PARA_FORWARD_SPEED, (0.32 / SLIDE_VEL));
        ...
        runMotor(-MAX_PERP_FORWARD_SPEED, MAX_PARA_FORWARD_SPEED, (2.5 / DIAGONAL_VEL));
        ...
        if (hue >= 215F && hue <= 265F) {
            ...
            runMotor(0.0, MAX_PARA_FORWARD_SPEED, 0.2);

            wait(0.2);

            //step back
            runMotor(0.0, -MAX_PARA_FORWARD_SPEED, 0.15);

            wait(0.2);

            //move to next beacon
            runMotor(-MAX_PERP_FORWARD_SPEED, 0.0, (3.96 / SLIDE_VEL));
        }
        else {

            //move to other side of beacon
            runMotor(-MAX_PERP_FORWARD_SPEED, 0.0, (0.22 / SLIDE_VEL));
            ...
            if (hue >= 215F && hue <= 265F) {
                ...
                //move to next beacon
                runMotor(-MAX_PERP_FORWARD_SPEED, 0.0, ((3.96 - 0.22) / SLIDE_VEL));
            }
            else {
